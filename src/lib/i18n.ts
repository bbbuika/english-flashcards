...
export const STRINGS = {
  ...
  scorekeeper: { tr: 'Aygucı', en: 'Scorekeeper' },
  scorekeeperFull: { tr: 'Aygucı (Töre Puanlayıcısı)', en: 'Aygucı (Scorekeeper)' },
  narrator: { tr: 'Kethüda', en: 'Narrator' },
  narratorFull: { tr: 'Kethüda (Oyun Anlatıcısı)', en: 'Kethüda (Narrator)' },
  ...
  pickScorekeeper: { tr: 'Aygucıyı seç', en: 'Pick the Aygucı' },
  ...
  currentTurn: { tr: 'Kethüda', en: 'Turn' },
